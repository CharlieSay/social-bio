...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      <footer className="text-center dark:text-white mt-16 mb-8 text-slate-500 container max-w-2xl mx-auto px-4 md:px-32 lg:px-32 flex justify-around">
        <section className="flex flex-col justify-center">
          <Link href="https://talesoft.digital/">
            <p className="text-xs pb-2">By</p>
            <svg
